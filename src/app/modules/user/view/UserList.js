import { Badge, Card, Divider, Flex, Grid, Group, NavLink, Text } from "@mantine/core"
...
import { UserSearch } from "../entry/UserSearch";
...
export const UserList = () => {
    ...
    const [params, setParams] = useState(userParamsInit);
    ...
    const columns = [
        ...
        // { accessor: "agree", title: 'Agree', sortable: true,  render : ({agree}) => {
        //     return (
        //         <div>{agree == '1' ? 'True' : 'False'}</div>
        //     )
        // }  },
        // { accessor: "jd", title: 'Job Description', sortable: true,  render : ({jd}) => {
        //     return (
        //         <div>{jd?.substring(0,5)} ...</div>
        //     )
        // }  },
    ];
    ...
    const loadingData = useCallback(async () => {
        setLoading(true);
        const response = await getReqeust("user-lists", params);
        ...
        <Grid gutter={0}>
            <Grid.Col span={12} my={10}>
                ...
                >
                    ...
                    <Group> 
                        <NavButton color={'red.8'} label="Create" disabled={loading} click={() => navigate("/user/new")} />
                    </Group>
                </Flex>
            </Grid.Col>
            ...
            <Grid.Col my={10}>
                <Card p={20} className="card-border">
                    <Card.Section my={10}>
                        <Text sx={{ fontSize: 20, fontWeight: 500}}> User List </Text>
